export function Hero() {
  return (
    <section className="relative bg-red-500 bg-center bg-no-repeat bg-cover header-height bg-hero before:content-[''] before:block before:w-full before:h-full before:bg-gray-950/50 before:absolute before:top-0 before:left-0">
