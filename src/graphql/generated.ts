...
export type PostCreateInput = {
  ...
  content: Scalars['String'];
  createdAt?: InputMaybe<Scalars['DateTime']>;
  postedAt?: InputMaybe<Scalars['Date']>;
  slug: Scalars['String'];
...
export type PostManyWhereInput = {
  ...
  postedAt?: InputMaybe<Scalars['Date']>;
  /** All values greater than the given value. */
  postedAt_gt?: InputMaybe<Scalars['Date']>;
  /** All values greater than or equal the given value. */
  postedAt_gte?: InputMaybe<Scalars['Date']>;
  /** All values that are contained in given list. */
  postedAt_in?: InputMaybe<Array<InputMaybe<Scalars['Date']>>>;
  /** All values less than the given value. */
  postedAt_lt?: InputMaybe<Scalars['Date']>;
  /** All values less than or equal the given value. */
  postedAt_lte?: InputMaybe<Scalars['Date']>;
  /** All values that are not equal to given value. */
  postedAt_not?: InputMaybe<Scalars['Date']>;
  /** All values that are not contained in given list. */
  postedAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['Date']>>>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type GetPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', content: string, createdAt: any, id: string, slug: string, subtitle?: string | null, title: string, banner?: { __typename?: 'Asset', url: string } | null }> };

export type GetHighlightPostQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHighlightPostQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', content: string, createdAt: any, id: string, slug: string, subtitle?: string | null, title: string, banner?: { __typename?: 'Asset', url: string } | null }> };
...
export const GetHighlightPostDocument = gql`
...
/**
 * __useGetHighlightPostQuery__
 *
 * To run a query within a React component, call `useGetHighlightPostQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetHighlightPostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetHighlightPostQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetHighlightPostQuery(baseOptions?: Apollo.QueryHookOptions<GetHighlightPostQuery, GetHighlightPostQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetHighlightPostQuery, GetHighlightPostQueryVariables>(GetHighlightPostDocument, options);
      }
export function useGetHighlightPostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetHighlightPostQuery, GetHighlightPostQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetHighlightPostQuery, GetHighlightPostQueryVariables>(GetHighlightPostDocument, options);
        }
export type GetHighlightPostQueryHookResult = ReturnType<typeof useGetHighlightPostQuery>;
export type GetHighlightPostLazyQueryHookResult = ReturnType<typeof useGetHighlightPostLazyQuery>;
export type GetHighlightPostQueryResult = Apollo.QueryResult<GetHighlightPostQuery, GetHighlightPostQueryVariables>;
